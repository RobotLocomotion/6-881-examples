...
class ManipulationStationSimulator:
    ...
    def RunSimulation(self, plan_list, gripper_setpoint_list,
                      ...
                      is_visualizing=True, sim_duration=None,
        ...
        @param is_visualizing: if true, adds MeshcatVisualizer to the Diagram. It should
            be set to False when running tests.
        @param sim_duration: the duration of simulation in seconds. If unset, it is set to
            the sum of the durations of all plans in plan_list plus extra_time.
        @param is_plan_runner_diagram: True: use the diagram version of PlanRunner;
            False: use the leaf version of PlanRunner.
        ...
        return iiwa_position_command_log, iiwa_position_measured_log, \
            iiwa_external_torque_log, plant_state_log, t_plan, contact_detector
    ...
    def RunRealRobot(self, plan_list, gripper_setpoint_list, sim_duration=None, extra_time=2.0,
        ...
        @param plan_list: A list of Plans to be executed.
        @param gripper_setpoint_list: A list of gripper setpoints.
            Each setpoint corresponds to a Plan.
        @param sim_duration: the duration of simulation in seconds. If unset, it is set
            to the sum of the durations of all plans in plan_list plus extra_time.
        @param extra_time: the amount of time for which commands are sent, in addition to
            the duration of all plans.
        @param is_plan_runner_diagram: True: use the diagram version of PlanRunner;
            False: use the leaf version of PlanRunner.
        @return: logs of robot configuration and torque, decoded from LCM messges sent by
            the robot's driver.
            Logs are SignalLogger systems, whose data can be accessed by SignalLogger.data().
        """
        builder = DiagramBuilder()
